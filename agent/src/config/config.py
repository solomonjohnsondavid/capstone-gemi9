...
REPO_ANALYZER_AGENT_NAME = get_config_variable("REPO_ANALYZER_AGENT_NAME")
...
REPO_ANALYZER_AGENT_MODEL = get_config_variable("REPO_ANALYZER_AGENT_MODEL")
TEST_GENERATOR_AGENT_MODEL = get_config_variable("TEST_GENERATOR_AGENT_MODEL")
